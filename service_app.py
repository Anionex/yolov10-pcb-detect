...
with gr.Blocks() as demo:
    ...
    btn_pred.click(lambda img: update_image("Predicted Image", img), inputs=[image_input], outputs=image_output)
    btn_label.click(lambda img: update_image("Labeled Image", img), inputs=[image_input], outputs=image_output)
    btn_grayscale.click(lambda img: update_image("Grayscale Image", img), inputs=[image_input], outputs=image_output)
    btn_binary.click(lambda img: update_image("Binary Image", img), inputs=[image_input], outputs=image_output)
    btn_edge.click(lambda img: update_image("Edge Image", img), inputs=[image_input], outputs=image_output)
